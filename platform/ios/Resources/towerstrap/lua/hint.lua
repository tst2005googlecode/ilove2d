...
function Hint:draw()
	...
	elseif(self.type == "fadeout") then
		...
		love.graphics.rectangle( "fill", self._x, self._y , 173, 43)
		love.graphics.setColor(0,0,0, self.alpha)
		love.graphics.printf(self.text, self._x, self._y + self.height, 173, "center")
	elseif(self.type == "fadeout2") then
	    love.graphics.setFont(font.impact_1)
		love.graphics.setColor(200,210,187, self.alpha)
		love.graphics.rectangle( "fill", self._x, self._y , 173, 43)
		love.graphics.setColor(0,0,0, self.alpha)
		love.graphics.printf(self.text, self._x, self._y + 30, 173, "center")
	end
