...
function love.nogame()
	...
	love.load = function()
		...
		Star.new = function(self, speed, scale)
			local o = {}
			o.image = images.star
			o.x = 320 + math.random(0, 320)
			o.y = -200 + math.random(0, 200)
			o.xt = -50;
			o.dy = 200
			o.dx = o.xt - o.x
			o.speed = speed
		...
		Knoll.new = function(self, pool, var, speed)
			...
			o.x = 800 + math.random(0, 800)
			o.y = 200 + var - math.random(0, var*2)
			o.xt = -200;
			o.dx = o.xt - o.x
			o.speed = speed
			o.duration = -o.dx/o.speed
			setmetatable(o, Knoll)
			return o
		end
	...
	love.draw = function()
		...
		love.graphics.rectangle("fill", 0, 440, 320, 40)
		love.graphics.setColor(205, 227, 161)
		love.graphics.rectangle("fill", 0, 430, 320, 10)
		love.graphics.setColor(255, 255, 255)

		lists.f:draw()
		
		love.graphics.print("Hi world!", 100, 300)
