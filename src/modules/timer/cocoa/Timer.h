...
#ifndef LOVE_TIMER_COCOA_TIMER_H
#define LOVE_TIMER_COCOA_TIMER_H
...
{
	/**
	* A Cocoa timer module. Can keep track of time between certain function
	...
	**/
	...
	private:
		...
		NSTimeInterval time_init;

		// Frame delta vars.
		NSTimeInterval currTime;
		NSTimeInterval prevTime;
		NSTimeInterval prevFpsUpdate;
...
#endif // LOVE_TIMER_COCOA_TIMER_H
