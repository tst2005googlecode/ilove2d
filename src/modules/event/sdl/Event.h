...
namespace sdl
{
	...
	private:
		...
		bool convert(FSDL_Event & e, Message & m);
		bool convert(Message & m, FSDL_Event & e);
		...
		static EnumMap<love::mouse::Mouse::Button, unsigned short, love::mouse::Mouse::BUTTON_MAX_ENUM>::Entry buttonEntries[];
		static EnumMap<love::mouse::Mouse::Button, unsigned short, love::mouse::Mouse::BUTTON_MAX_ENUM> buttons;
